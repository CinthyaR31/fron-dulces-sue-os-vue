<template>
  <div class="card" id="carta_tortas">
    <img src="logos/imagenes formulario/Carta entremet.png" class="card-img-top" alt="select entremet">
    <div class="card-body">
      <h4 class="card-title text-center">Personaliza tu {{ producto.nombre_producto }}</h4>
      <p class="card-text text-center">Primero, selecciona el sabor del mousse (base). Segundo, selecciona el sabor
...
export default {
  data() {
    return {
      ...
      sabor_base: [
        'Chocolate', 'Arequipe', 'Yogurt griego', 'Café', 'Frutos rojos'
      ],
      sabor_relleno: [
        'Guanabana', 'Frutos rojos', 'Maracuyá', 'Mora'
      ],
      color_decoracion: [
        'Azul', 'Rosa', 'Rojo', 'Morado','Negro'
